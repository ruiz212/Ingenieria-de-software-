...
class Config:
    SQL_SERVER_CONNECTION_STRING = os.environ.get('DB_CONNECTION_STRING') or r'DRIVER={ODBC Driver 17 for SQL Server};SERVER=DESKTOP-A45EBFM;DATABASE=PanaderiaDB;Trusted_Connection=yes;Encrypt=yes;TrustServerCertificate=yes;'
